...
Auth.registerAuth = function (app) {
  ...
  app.get('/gateway/oauth', function (req, res) {
    ...
    GatewayModel.registerClient(state, client);
  ...
  app.get('/allow', function (req, res) {
    ...
    const client = GatewayModel.getClient(state);
    ...
    GatewayModel.registerClient(code, client);
  ...
  app.all('/token', function (req, res) {
    ...
    const client = GatewayModel.getClient(code);
